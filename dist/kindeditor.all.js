...
KindEditor.plugin('baidumap', function (K) {
    var self = this, name = 'baidumap', lang = self.lang(name + '.'), mapWidth = K.undef(self.mapWidth, 558), mapHeight = K.undef(self.mapHeight, 360);
    function getMapHtml() {
