        ...
        var dialog = self.createDialog({
            ...
            yesBtn: {
                ...
                click: function (e) {
                    ...
                    var url = [
                        checkbox[0].checked ? mapHtml : '//api.map.baidu.com/staticimage',
                        '?copyright=1',
                        ...
                        '&markerStyles=' + encodeURIComponent('l')
                    ].join('');
